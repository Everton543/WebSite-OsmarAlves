...
<body>
    ...
    <h1>Atualizar Foto Pré-wedding</h1>
                ...
                <table id="fotosMenu">
                    <tr>
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/preWedding/image1.jpg"
                            id="1"
                            onclick="check(\'../imagens/preWedding/image1.jpg \', 1)"/>
                        </th>

                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/preWedding/image2.jpg" 
                            id="2"
                            onclick="check(\'../imagens/preWedding/image2.jpg \', 2)"/>
                        </th>

                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/preWedding/image3.jpg"
                            id="3"
                            onclick="check(\'../imagens/preWedding/image3.jpg \', 3)"/>
                        </th>
                    </tr>
        
                    <tr>
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/preWedding/image4.jpg" 
                            id="4"
                            onclick="check(\'../imagens/preWedding/image4.jpg \', 4)"/>
                        </th>
            
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/preWedding/image5.jpg" 
                            id="5"
                            onclick="check(\'../imagens/preWedding/image5.jpg \', 5)"/>
                        </th>
                
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/preWedding/image6.jpg" 
                            id="6"
                            onclick="check(\'../imagens/preWedding/image6.jpg \', 6)"/>
                        </th>
                    </tr>
                </table>
                <i class="fa fa-arrow-left clicavel"
                onclick="anterior(\'../imagens/preWedding/image\', 12)"></i>

                <i class="fa fa-arrow-right clicavel"
                onclick="proximo(\'../imagens/preWedding/image\', 12)"></i>
