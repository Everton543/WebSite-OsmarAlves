	    ...
	    if($_SERVER['REQUEST_METHOD'] === 'POST'){
                ...
                <table id="fotosMenu">
                    <tr>
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/slide/image1.jpg"
                            id="1"
                            onclick="check(\'../imagens/slide/image1.jpg \', 1)"/>
                        </th>

                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/slide/image2.jpg" 
                            id="2"
                            onclick="check(\'../imagens/slide/image2.jpg \', 2)"/>
                        </th>
                    </tr>
        
                    <tr>
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/slide/image3.jpg"
                            id="3"
                            onclick="check(\'../imagens/slide/image3.jpg \', 3)"/>
                        </th>

                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/slide/image4.jpg" 
                            id="4"
                            onclick="check(\'../imagens/slide/image4.jpg \', 4)"/>
                        </th>           
                    </tr>
                </table>
            ...
            if(isset($_POST["submit"]) && isset($_POST['fotoSelectionada'])) {
                ...
                if($foto != ""){
                    ...
                    $storeDirectory = "../imagens/slide/".$fileName;
                    echo $storeDirectory;
