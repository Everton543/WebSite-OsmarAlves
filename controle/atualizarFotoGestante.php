                ...
                <table id="fotosMenu">
                    <tr>
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/gestante/image1.jpg"
                            id="1"
                            onclick="check(\'../imagens/gestante/image1.jpg \', 1)"/>
                        </th>

                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/gestante/image2.jpg" 
                            id="2"
                            onclick="check(\'../imagens/gestante/image2.jpg \', 2)"/>
                        </th>

                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/gestante/image3.jpg"
                            id="3"
                            onclick="check(\'../imagens/gestante/image3.jpg \', 3)"/>
                        </th>
                    </tr>
        
                    <tr>
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/gestante/image4.jpg" 
                            id="4"
                            onclick="check(\'../imagens/gestante/image4.jpg \', 4)"/>
                        </th>
            
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/gestante/image5.jpg" 
                            id="5"
                            onclick="check(\'../imagens/gestante/image5.jpg \', 5)"/>
                        </th>
                
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/gestante/image6.jpg" 
                            id="6"
                            onclick="check(\'../imagens/gestante/image6.jpg \', 6)"/>
                        </th>
                    </tr>
                </table>
                <i class="fa fa-arrow-left clicavel"
                onclick="anterior(\'../imagens/gestante/image\', 12)"></i>

                <i class="fa fa-arrow-right clicavel"
                onclick="proximo(\'../imagens/gestante/image\', 12)"></i>
