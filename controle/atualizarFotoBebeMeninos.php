...
<body>
    ...
    <h1>Atualizar Mês a Mês Meninos</h1>
                ...
                <table id="fotosMenu">
                    <tr>
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/bebeMeninos/image1.jpg"
                            id="1"
                            onclick="check(\'../imagens/bebeMeninos/image1.jpg \', 1)"/>
                        </th>

                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/bebeMeninos/image2.jpg" 
                            id="2"
                            onclick="check(\'../imagens/bebeMeninos/image2.jpg \', 2)"/>
                        </th>

                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/bebeMeninos/image3.jpg"
                            id="3"
                            onclick="check(\'../imagens/bebeMeninos/image3.jpg \', 3)"/>
                        </th>
                    </tr>
        
                    <tr>
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/bebeMeninos/image4.jpg" 
                            id="4"
                            onclick="check(\'../imagens/bebeMeninos/image4.jpg \', 4)"/>
                        </th>
            
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/bebeMeninos/image5.jpg" 
                            id="5"
                            onclick="check(\'../imagens/bebeMeninos/image5.jpg \', 5)"/>
                        </th>
                
                        <th class="escolherFoto">
                            <img class="escolher clicavel" src="../imagens/bebeMeninos/image6.jpg" 
                            id="6"
                            onclick="check(\'../imagens/bebeMeninos/image6.jpg \', 6)"/>
                        </th>
                    </tr>
                </table>
                <i class="fa fa-arrow-left clicavel"
                onclick="anterior(\'../imagens/bebeMeninos/image\', 30)"></i>

                <i class="fa fa-arrow-right clicavel"
                onclick="proximo(\'../imagens/bebeMeninos/image\', 30)"></i>
